...
public class HostingSelection extends SurveyResAndDev {
    ...
    public void hostingFirstChoice(WebDriver driver) throws InterruptedException {
    ...
    public void hostingFifthChoice(WebDriver driver, String string) throws InterruptedException {
