...
public class HostingPage {
	...
	WebElement EngineeringPageBackButton;
	...
	@FindBy(xpath="//div[@class='current-state']//div[1]//div[1]//div[2]")
	WebElement CurrentStateofCostMaintainability;
	
	@FindBy(xpath="//div[@class='current-state']//div[2]//div[1]//div[2]")
	WebElement CurrentStateofFunctionalRangeFutureProof;
	
	@FindBy(xpath="//div[@class='current-state']//div[3]//div[1]//div[2]")
	WebElement CurrentStateofAvailability;
	
	@FindBy(xpath="//div[@class='current-state']//div[4]//div[1]//div[2]")
	WebElement CurrentStateofSecurity;
	
	@FindBy(xpath="//div[@class='current-state']//div[5]//div[1]//div[2]")
	WebElement CurrentStateofInnovationTimetoMarket;
	...
	public void clickOnEngineeringPageBackButton() throws InterruptedException
	{
		EngineeringPageBackButton.click();
		Thread.sleep(5000);	
	}
	...
	public void verifyHostingPageProgressBar() throws InterruptedException
	{
		String currentStateofCostMaintainability = CurrentStateofCostMaintainability.getAttribute("Style");
		System.out.println("CurrentStateofCostMaintainability: " +currentStateofCostMaintainability);
		Thread.sleep(1000);	
		String currentStateofFunctionalRangeFutureProof = CurrentStateofFunctionalRangeFutureProof.getAttribute("Style");
		System.out.println("currentStateofFunctionalRangeFutureProof: " +currentStateofFunctionalRangeFutureProof);
		Thread.sleep(1000);	
		String currentStateofAvailability = CurrentStateofAvailability.getAttribute("Style");
		System.out.println("CurrentStateofAvailability: " +currentStateofAvailability);
		Thread.sleep(1000);	
		String currentStateofSecurity = CurrentStateofSecurity.getAttribute("Style");
		System.out.println("CurrentStateofSecurity: " +currentStateofSecurity);
		Thread.sleep(1000);	
		String currentStateofInnovationTimetoMarket = CurrentStateofInnovationTimetoMarket.getAttribute("Style");
		System.out.println("CurrentStateofInnovationTimetoMarket: " +currentStateofInnovationTimetoMarket);
		Thread.sleep(1000);	
	}
